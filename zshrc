...
POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(custom_toto  custom_tata battery dir vcs)
POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(status time dir_writable ip custom_wifi_signal ram load background_jobs node_version)
...
POWERLEVEL9K_CUSTOM_TATA="echo -n '\uE242 Vbax'"
